                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText1" name="txt_bonusname" placeholder="Nhập tên thưởng..." value="{{ old('txt_bonusname') }}">
                                                {!! show_error($errors,'txt_bonusname') !!}
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputNumber1">Tiền thưởng</label>
                                                <input type="number" class="form-control" id="exampleInputNumber1" name="txt_bonus" placeholder="Số tiền..." value="{{ old('txt_bonus') }}">
