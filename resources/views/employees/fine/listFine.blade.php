                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Thông tin phạt</h3>
                                    <a href="/admin/add-fine" class="btn btn-primary" style="float: right;">Thêm mới</a>
                                    ...
                                    <table class="table table-bordered" id="table_id">
                                        ...
                                        <tbody>
                                            ...
                                            <?php $i=1;?>
                                                ...
                                                <td>
                                                    <a href="/admin/edit-fine/{{ $row->ordinal_id }}" class="fas fa-edit" title="Sửa"></a>
                                                    <a href="/admin/delete-fine/{{ $row->ordinal_id }}" onclick="return confirm('Bạn có chắc chắn muốn xóa?');" class="fas fa-trash-alt" title="Xóa"></a>
                                                </td>
                                            </tr>
                                                @endforeach
                                            @endif
