                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText1" name="txt_position" placeholder="Nhập chức vụ..." value="{{ old('txt_position') }}">
                                                {!! show_error($errors,'txt_position') !!}
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputNumber1">Lương cơ bản</label>
                                                <input type="number" class="form-control" id="exampleInputNumber1" name="txt_basicsalary" placeholder="Hệ số lương..." value="{{ old('txt_basicsalary') }}">
