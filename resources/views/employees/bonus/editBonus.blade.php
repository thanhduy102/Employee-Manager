                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @foreach ($employee as $row)
                                                <option value="{{ $row->employee_id }}" {{ $row->employee_id==$bonus_info->employee_id ? 'selected' : ''}}>{{ $row->employee_id }} - {{ $row->full_name }}</option>
                                            @endforeach
                                            </select> --}}
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="bonus_reason">
                                              ...
                                              @foreach ($bonus_detail as $row)
                                                  <option value="{{ $row->bonus_id }}" {{ $row->bonus_id==$bonus_info->bonus_id ? 'selected' : '' }}>{{ $row->bonus_reason }}</option>
                                              @endforeach
