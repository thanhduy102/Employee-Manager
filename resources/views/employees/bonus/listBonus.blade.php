                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a href="/admin/add-bonus" class="btn btn-primary" style="float: right;">Thêm mới</a>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="table_id">
                                        ...
                                        <tbody>
                                            @if ($bonus_info_count==0)
                                                <tr>
                                                    <td colspan="10">Danh sách trống!</td>
                                                </tr>
                                            @else
                                            <?php $i=1;?>
                                                @foreach ($bonus_info as $row)
                                                    <tr>
                                                <td>{{ $i++ }}</td>
                                                ...
                                                <td>
                                                    <a href="/admin/edit-bonus/{{ $row->ordinal_id }}" class="fas fa-edit" title="Sửa"></a>
                                                    <a href="/admin/delete-bonus/{{ $row->ordinal_id }}" onclick="return confirm('Bạn chắc chắn muốn xóa?');" class="fas fa-trash-alt" title="Xóa"></a>
                                                </td>
                                            </tr>
                                                @endforeach
                                            @endif
