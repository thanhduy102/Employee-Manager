                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputName" name="txt_name" value="{{ $employee_id->full_name }}" placeholder="Nhập họ tên...">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="txt_gender" id="exampleInputGender">
                                                    ...
                                                    <option value="Nam" {{ $employee_id->gender=="Nam" ? 'selected' : '' }}>Nam</option>
                                                    <option value="Nữ" {{ $employee_id->gender=="Nữ" ? 'selected' : '' }}>Nữ</option>
                                                    <option value="Khác" {{ $employee_id->gender=="Khác" ? 'selected' : '' }}>Khác</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" name="txt_level" id="exampleInputLevel">
                                                    ...
                                                    @foreach ($level as $row)
                                                        <option value="{{ $row->level_id }}" {{ $row->level_id==$employee_id->level_id ? 'selected' : '' }}>{{ $row->level_name }}</option>
                                                    @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                @foreach ($position as $row)
                                                    <option value="{{ $row->position_id }}" {{ $row->position_id==$employee_id->position_id ? 'selected' : '' }}>{{ $row->position_name }}</option>
                                                @endforeach
                                            ...
                                            <div class="form-group">
                                                ...
                                                @foreach ($department as $row)
                                                    <option value="{{ $row->department_id }}" {{ $row->department_id==$employee_id->department_id ? 'selected' : '' }}>{{ $row->department_name }}</option>
                                                @endforeach
