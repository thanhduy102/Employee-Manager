                                    ...
                                    <div>
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputText1" name="txt_finename" placeholder="Thông tin phạt..." value="{{ old('txt_finename') }}">
                                                {!! show_error($errors,'txt_finename') !!}
                                            </div>
                                            <div class="form-group">
                                                <label for="exampleInputNumber1">Tiền phạt</label>
                                                <input type="number" class="form-control" id="exampleInputNumber1" name="txt_fine" placeholder="Số tiền..." value="{{ old('txt_fine') }}">
